 ...
 const descriptions = {  codeSmell: `
    ...
    <a href="https://www.sonarsource.com/learn/code-smells/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  serverlessComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Serverless Computing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://cloud.google.com/discover/what-is-serverless-computing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  webFlow: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Web Flow</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
  ...
  webHooks: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Web Hooks</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://zapier.com/blog/what-are-webhooks/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  llms: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">LLMs</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/what-is/large-language-model/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  openSource: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Open Source</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://opensource.com/resources/what-open-source" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  webScraping: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Web Scraping</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.geeksforgeeks.org/what-is-web-scraping-and-how-to-use-it/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  frontEnd: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Front End</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://flatironschool.com/blog/front-end-vs-back-end-development/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  fullStack: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Full Stack</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/what-is/full-stack-development/#:~:text=Full%20stack%20development%20is%20the,user%20interactions%20with%20the%20application." class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  functions: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Functions</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.w3schools.com/js/js_functions.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  arguments: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Arguments</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions#parameters" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dictionary: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Dictionary</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.w3schools.com/python/python_dictionaries.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  tuple: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Tuple</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.w3schools.com/python/python_tuples.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  list: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">List</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.w3schools.com/python/python_lists.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  boolean: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Boolean</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.w3schools.com/js/js_booleans.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  string: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">String</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.w3schools.com/python/python_strings.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  floats: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Floats</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.w3schools.com/python/python_datatypes.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  double: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Double</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.w3schools.com/java/java_data_types.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataTypes: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Types</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
  ...
  threads: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Threads</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.techtarget.com/whatis/definition/thread/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  classes: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Classes</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://brilliant.org/wiki/classes-oop/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  objects: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Objects</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.geeksforgeeks.org/what-are-objects-in-programming/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  inheritance: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Inheritance</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.enjoyalgorithms.com/blog/inheritance-in-java" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  syntax: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Syntax</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://woz-u.com/blog/what-is-syntax-in-computer-programming/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  ide: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">IDE (Integrated Development Environment)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/what-is/ide/#:~:text=An%20integrated%20development%20environment%20(IDE,easy%2Dto%2Duse%20application." class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  debugger: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Debugger</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://medium.com/@dwivedi.ankit21/the-debugger-a-behind-the-scenes-look-at-how-it-works-983a65883e97" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  deployment: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Deployment</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.ibm.com/docs/en/zos/2.4.0?topic=task-deploying-software" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  continuousDeployment: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Continuous Deployment</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.atlassian.com/continuous-delivery/software-testing/continuous-deployment" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  deploymentPipeline: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Deployment Pipeline</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.pagerduty.com/resources/learn/what-is-a-deployment-pipeline/#:~:text=In%20software%20development%2C%20a%20deployment,%2C%20building%2C%20and%20deploying%20code." class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataValidation: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Validation</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.tibco.com/glossary/what-is-data-validation#:~:text=Data%20validation%20is%20the%20process,validation%20to%20ensure%20accurate%20results." class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataSerialization: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Serialization</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://medium.com/@jdelamettrie/data-serialization-631a0325c38a" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  mocking: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Mocking</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.geeksforgeeks.org/software-testing-mock-testing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  authentication: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Authentication</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://medium.com/geekculture/authentication-and-authorization-a5a2eafdde16" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  authorization: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Authorization</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
  ...
  prototypes: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Prototypes (Software Development)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.techtarget.com/searcherp/definition/prototype#:~:text=Prototype%2Dbased%20programming%20generates%20an,code%20and%20how%20it%20executes." class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  monolithicArchitecture: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Monolithic Architecture</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://tech.tamara.co/monolith-architecture-5f00270f384e" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  github: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">GitHub</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://medium.com/swlh/an-introduction-to-git-and-github-22ecb4cb1256" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  orm: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">ORM (Object-Relational Mapping)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://medium.com/@grover.vinayak0611/what-is-orm-why-to-use-it-and-brief-introduction-of-orm-frameworks-b61b16d02a3c" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  caching: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Caching</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://hazelcast.com/glossary/caching/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  // ENDS HERE, 07/27
  machineLearning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Machine Learning</h2>
    <br>
    ...
    <a href="https://mitsloan.mit.edu/ideas-made-to-matter/machine-learning-explained" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  
  `,
  deepLearning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Deep Learning</h2>
    <br>
    ...
    <br>
    <a href="https://www.ibm.com/topics/deep-learning" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  artificialIntelligence: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Artificial Intelligence</h2>
    <br>
    ...
    <br>
    <a href="https://www.ibm.com/topics/artificial-intelligence" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  cybersecurity: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cybersecurity</h2>
    <br>
    ...
    <br>
    <a href="https://www.ibm.com/topics/cybersecurity" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  epochs: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Epochs</h2>
    <br>
    ...
    <br>
    <a href="https://www.simplilearn.com/tutorials/machine-learning-tutorial/what-is-epoch-in-machine-learning" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  apis: `
    ...
    <br>
    <a href="https://www.postman.com/what-is-an-api/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  cloudComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cloud Computing</h2>
    <br>
    ...
    <br>
    <a href="https://azure.microsoft.com/en-us/resources/cloud-computing-dictionary/what-is-cloud-computing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataScience: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Science</h2>
    <br>
    ...
    <br>
    <a href="https://www.ibm.com/topics/data-science" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  quantumComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Quantum Computing</h2>
    <br>
    ...
    <br>
    <a href="https://www.explainthatstuff.com/quantum-computing.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  internetOfThings: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Internet of Things</h2>
    <br>
    ...
    <br>
    <a href="https://www.oracle.com/internet-of-things/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a> alt="Internet of Things image">
  `,
  blockchain: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Blockchain</h2>
    <br>
    ...
    <br>
    <a href="https://builtin.com/blockchain" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  reactJS: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">ReactJS</h2>
    <br>
    ...
    <br>
    <a href="https://www.freecodecamp.org/news/react-for-beginners-handbook/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  docker: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Docker</h2>
    <br>
    ...
    <br>
    <a href="https://docker-curriculum.com/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  initFunction: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">__init__ Function</h2>
    <br>
  ...
  python: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Python</h2>
    <br>
    ...
    <br>
    <a href="https://example.com" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  threeSigmaRule: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Three-Sigma Rule</h2>
    <br>
    ...
    <br>
    <a href="https://www.investopedia.com/terms/t/three-sigma-limits.asp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  recursion: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Recursion</h2>
    <br>
    ...
    <br>
    <a href="https://2533.medium.com/recursion-explained-with-pictures-72578d28058a" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  git: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Git</h2>
    <br>
    ...
    <br>
    <a href="https://dev.to/milu_franz/git-explained-the-basics-igc" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
    <br>
    
  `,
  versionControl: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Version Control</h2>
    <br>
    ...
    <br>
    <a href="https://about.gitlab.com/topics/version-control/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  microservices: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Microservices</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/microservices/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  restfulAPI: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">RESTful API</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/what-is/restful-api/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  graphql: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">GraphQL</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.solo.io/topics/graphql/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  containerization: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Containerization</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/what-is/containerization/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  kubernetes: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Kubernetes</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://kubernetes.io/docs/concepts/overview/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  branching: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Branching</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://medium.com/@jacoblogan98/understanding-git-branching-5d01f3dda541" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  merging: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Merging</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://atlassian.com/git/tutorials/using-branches/git-merge" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  pullRequests: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Pull Requests (PR)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  
  agile: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Agile</h2>
    <br>
    ...
    <br>
    <a href="https://www.spiceworks.com/tech/devops/articles/what-is-agile-software-development/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  scrum: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Scrum</h2>
    <br>
    ...
    <br>
    <a href="https://www.scrum.org/resources/what-scrum-module" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  kanban: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Kanban</h2>
    <br>
    ...
    <br>
    <a href="https://www.atlassian.com/agile/kanban" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  sql: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">SQL</h2>
    <br>
    ...
    <br>
    <a href="https://aws.amazon.com/what-is/sql/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  nosql: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">NoSQL</h2>
    <br>
    ...
    <a href="https://radixweb.com/blog/introduction-to-continuous-deployment#Continuous" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  html: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">HTML</h2>
    <br>
    ...
    <br>
    <a href="https://www.hostinger.com/tutorials/what-is-html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  css: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">CSS</h2>
    <br>
    ...
    <br>
    <a href="https://www.hostinger.com/tutorials/what-is-css" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  java: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Java</h2>
    <br>
    ...
    <br>
    <a href="https://www.simplilearn.com/tutorials/java-tutorial/what-is-java" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  cSharp: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">C#</h2>
    <br>
    ...
    <br>
    <a href="https://dotnet.microsoft.com/en-us/languages/csharp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  php: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">PHP</h2>
    <br>
    ...
    <br>
     <a href="https://www.freecodecamp.org/news/what-is-php-the-php-programming-language-meaning-explained/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  ruby: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Ruby</h2>
    <br>
    ...
    <br>
     <a href="https://developer.oracle.com/learn/technical-articles/what-is-ruby" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  swift: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Swift</h2>
    <br>
    ...
    <br>
     <a href="https://developer.apple.com/swift/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  typescript: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">TypeScript</h2>
    <br>
   ...
   <br>
     <a href="https://www.typescripttutorial.net/typescript-tutorial/what-is-typescript/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>

  `,
  kotlin: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Kotlin</h2>
    <br>
    ...
    <br>
     ...
     <a href="https://www.techtarget.com/whatis/definition/Kotlin" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  bash: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Bash</h2>
    <br>
    ...
    <br>
    <a href="https://opensource.com/resources/what-bash" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  rubyOnRails: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Ruby on Rails</h2>
    <br>
    ...
    <img class="responsive-image" src="assets/images/rubyOnRails.jpg" alt="Ruby on Rails image">
     <br>
     <a href="https://www.codecademy.com/resources/blog/what-is-ruby-on-rails/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  angular: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Angular</h2>
    <br>
    ...
    <img class="responsive-image" src="https://www.aalpha.net/wp-content/uploads/2019/07/angularjs-development-india.jpg" alt="Angular image">
     <br>
     <a href="https://v17.angular.io/guide/what-is-angular" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  vueJS: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">VueJS</h2>
    <br>
    ...
    <img class="responsive-image" src="https://v1.vuejs.org/images/mvvm.png" alt="VueJS image">
     <br>
     <a href="https://v1.vuejs.org/guide/overview.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  flutter: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Flutter</h2>
    <br>
    ...
    <img class="responsive-image" src="assets/images/flutter.jpg" alt="Flutter image">
     <br>
     <a href="https://techvify-software.com/wp-content/uploads/2023/07/how-flutter-works.jpg" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  swiftUI: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">SwiftUI</h2>
    <br>
    ...
    <br>
     <a href="https://www.adjust.com/blog/get-started-with-swiftui/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  algorithm: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Algorithm</h2>
    <br>
    ...
    <img class="responsive-image" src="https://cdn.ttgtmedia.com/rms/onlineimages/types_of_algorithms-f_mobile.png" alt="Algorithm image">
     <br>
     <a href="https://www.geeksforgeeks.org/introduction-to-algorithms/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataStructure: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Structure</h2>
    <br>
    ...
    <img class="responsive-image" src="https://media.geeksforgeeks.org/wp-content/uploads/20220520182504/ClassificationofDataStructure-660x347.jpg" alt="Data Structure image">
     <br>
     <a href="https://www.w3schools.com/dsa/dsa_intro.php" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  bigO: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Big O Notation</h2>
    <br>
    ...
    <br>
     <a href="https://www.freecodecamp.org/news/big-o-notation-why-it-matters-and-why-it-doesnt-1674cfa8a23c/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  recursionDepth: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Recursion Depth</h2>
    <br>
  ...
  `,
  debugging: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Debugging</h2>
    <br>
    ...
    <img class="responsive-image" src="https://www.edureka.co/blog/wp-content/uploads/2019/08/debuuging-steps-528x294.png" alt="Debugging image">
     <br>
     <a href="https://www.ibm.com/topics/debugging" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  testing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Testing</h2>
    <br>
    ...
    <br>
     ...
     <a href="https://www.ibm.com/topics/software-testing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  unitTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Unit Test</h2>
    <br>
    ...
    <img class="responsive-image" src="https://codenboxautomationlab.com/wp-content/uploads/2022/06/unit-testing-life-cycle-pic.png" alt="Unit Test image">
     <br>
     <a href="https://aws.amazon.com/what-is/unit-testing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  integrationTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Integration Test</h2>
    <br>
    ...
    <img class="responsive-image" src="https://www.simform.com/wp-content/uploads/2022/01/Integration-testing-types.png" alt="Integration Test image">
     <br>
     <a href="https://katalon.com/resources-center/blog/integration-testing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  endToEndTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">End-to-End Test</h2>
    <br>
    ...
    <img class="responsive-image" src="https://cdn.prod.website-files.com/610bb663a35dd3364ddbf08c/62b594796e28e910d6624e03_end-to-end-testing-metrics.png" alt="End-to-End Test image">
     <br>
     <a href="https://smartbear.com/learn/automated-testing/what-is-end-to-end-testing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  performanceTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Performance Test</h2>
    <br>
    ...
    <img class="responsive-image" src="https://www.a1qa.com/wp-content/uploads/2019/06/performance-testing.jpg" alt="Performance Test image">
     <br>
     <a href="https://en.wikipedia.org/wiki/Software_performance_testing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  loadTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Load Test</h2>
    <br>
    ...
    <br>
     ...
     <a href="https://en.wikipedia.org/wiki/Software_load_testing#:~:text=Load%20testing%20generally%20refers%20to,model%2C%20such%20as%20web%20servers." class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  stressTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Stress Test</h2>
    <br>
    ...
    <br>
     ...
     <a href="https://www.geeksforgeeks.org/stress-testing-software-testing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  securityTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Security Test</h2>
    <br>
    ...
    <br>
     ...
     <a href="https://www.hackerone.com/knowledge-center/what-security-testing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  usabilityTest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Usability Test</h2>
    <br>
    ...
    <br>
     ...
     <a href="https://www.geeksforgeeks.org/usability-testing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  codeReview: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Code Review</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://about.gitlab.com/topics/version-control/what-is-code-review/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  refactoring: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Refactoring</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://refactoring.guru/refactoring/what-is-refactoring" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  technicalDebt: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Technical Debt</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://asana.com/resources/technical-debt" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  designPatterns: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Design Patterns</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://refactoring.guru/design-patterns/what-is-pattern" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  solidPrinciples: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">SOLID Principles</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/SOLID" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  kissPrinciple: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">KISS Principle</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/KISS_principle" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dryPrinciple: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">DRY Principle</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://thevaluable.dev/dry-principle-cost-benefit-example/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  uat: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">UAT</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.guru99.com/user-acceptance-testing.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  testDrivenDevelopment: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Test-Driven Development</h2>
    <br>
    ...
    <br>
     <a href="https://testdriven.io/test-driven-development/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  continuousIntegration: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Continuous Integration</h2>
    <br>
    ...
    <img class="responsive-image" src="https://www.pagerduty.com/wp-content/uploads/2020/01/continuous-integration-2.png" alt="Continuous Integration image">
     <br>
     <a href="https://aws.amazon.com/devops/continuous-integration/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  continuousDelivery: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Continuous Delivery</h2>
    <br>
    ...
    <img class="responsive-image" src="https://infraascode.com.br/images/ci_cd-CD.png" alt="Continuous Delivery image">
     <br>
     <a href="https://aws.amazon.com/devops/continuous-delivery/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  devOps: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">DevOps</h2>
    <br>
    ...
    <img class="responsive-image" src="https://d1.awsstatic.com/product-marketing/DevOps/DevOps_feedback-diagram.ff668bfc299abada00b2dcbdc9ce2389bd3dce3f.png" alt="DevOps image">
     <br>
     <a href="https://aws.amazon.com/devops/what-is-devops/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  logisticRegression: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Logistic Regression</h2>
    <br>
    ...
    <a href="https://towardsdatascience.com/introduction-to-logistic-regression-66248243c148" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  kMeansClustering: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">K-Means Clustering</h2>
    <br>
    ...
    <a href="https://www.analyticsvidhya.com/blog/2020/10/a-simple-explanation-of-k-means-clustering/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  decisionTrees: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Decision Trees</h2>
    <br>
    ...
    <a href="https://chirag-sehra.medium.com/decision-trees-explained-easily-28f23241248" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  randomForest: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Random Forest</h2>
    <br>
    ...
    <a href="https://medium.com/@denizgunay/random-forest-af5bde5d7e1e" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  supportVectorMachines: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Support Vector Machines</h2>
    <br>
    ...
    <a href="https://www.kdnuggets.com/2016/07/support-vector-machines-simple-explanation.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  gradientDescent: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Gradient Descent</h2>
    <br>
    ...
    <br>
    <a href="https://towardsdatascience.com/gradient-descent-explained-9b953fc0d2c" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  neuralNetworks: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Neural Networks</h2>
    <br>
    ...
    <a href="https://www.freecodecamp.org/news/deep-learning-neural-networks-explained-in-plain-english/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  naturalLanguageProcessing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Natural Language Processing</h2>
    <br>
  ...
  recurrentNeuralNetworks: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Recurrent Neural Networks</h2>
    <br>
    ...
    <a href="https://media.geeksforgeeks.org/wp-content/uploads/20240524132821/nlp-working.webp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  convolutionalNeuralNetworks: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Convolutional Neural Networks</h2>
    <br>
    ...
    <a href="https://nafizshahriar.medium.com/what-is-convolutional-neural-network-cnn-deep-learning-b3921bdd82d5" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  autoencoders: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Autoencoders</h2>
    <br>
    ...
    <a href="https://medium.com/@birla.deepak26/autoencoders-76bb49ae6a8f" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  reinforcementLearning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Reinforcement Learning</h2>
    <br>
    ...
    <a href="https://www.spiceworks.com/tech/artificial-intelligence/articles/what-is-reinforcement-learning/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  transferLearning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Transfer Learning</h2>
    <br>
    ...
    <a href="https://www.v7labs.com/blog/transfer-learning-guide" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  hyperparameterTuning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Hyperparameter Tuning</h2>
    <br>
    ...
    <a href="https://www.analyticsvidhya.com/blog/2022/02/a-comprehensive-guide-on-hyperparameter-tuning-and-its-techniques/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  crossValidation: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cross-Validation</h2>
    <br>
    ...
    <a href="https://www.geeksforgeeks.org/cross-validation-machine-learning/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  featureEngineering: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Feature Engineering</h2>
    <br>
    ...
    <a href="https://builtin.com/articles/feature-engineering" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  featureScaling: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Feature Scaling</h2>
    <br>
  ...
  overfitting: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Overfitting</h2>
    <br>
    ...
    <a href="https://www.geeksforgeeks.org/underfitting-and-overfitting-in-machine-learning/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  underfitting: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Underfitting</h2>
    <br>
  ...
  regularization: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Regularization</h2>
    <br>
    ...
    <a href="" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  bagging: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Bagging</h2>
    <br>
    ...
    <a href="https://www.ibm.com/topics/bagging" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  boosting: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Boosting</h2>
    <br>
    ...
    <a href="https://aws.amazon.com/what-is/boosting/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  ensembleMethods: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Ensemble Methods</h2>
    <br>
    ...
    <a href="https://corporatefinanceinstitute.com/resources/data-science/ensemble-methods/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  rocCurve: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">ROC Curve</h2>
    <br>
    ...
    <a href="https://medium.com/@shaileydash/understanding-the-roc-and-auc-intuitively-31ca96445c02" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  aucCurve: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">AUC Curve</h2>
    <br>
    ...
    <a href="https://medium.com/@shaileydash/understanding-the-roc-and-auc-intuitively-31ca96445c025" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  precisionRecall: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Precision and Recall</h2>
    <br>
    ...
    <a href="https://www.analyticsvidhya.com/blog/2020/09/precision-recall-machine-learning/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  f1Score: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">F1 Score</h2>
    <br>
    ...
    <a href="https://www.v7labs.com/blog/f1-score-guide" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  confusionMatrix: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Confusion Matrix</h2>
    <br>
    ...
    <a href="https://www.analyticsvidhya.com/blog/2020/04/confusion-matrix-machine-learning/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  crossEntropy: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cross-Entropy</h2>
    <br>
    ...
    <a href="https://towardsdatascience.com/what-is-cross-entropy-3bdb04c13616" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  // Start from here - 01/08
  noSQLDatabases: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">NoSQL Databases</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.mongodb.com/nosql-explained" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  microservicesArchitecture: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Microservices Architecture</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://microservices.io/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  serverlessArchitecture: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Serverless Architecture</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://serverless.com/learn/what-is-serverless/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  webAssembly: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">WebAssembly (Wasm)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://webassembly.org/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  edgeComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Edge Computing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.ibm.com/cloud/what-is-edge-computing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  zeroTrustSecurityModel: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Zero Trust Security Model</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.csoonline.com/article/3247848/what-is-zero-trust-a-model-for-more-effective-security.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dockerSwarm: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Docker Swarm</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://docs.docker.com/engine/swarm/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  oAuth2_0: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">OAuth 2.0</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://oauth.net/2/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  jwt: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">JWT (JSON Web Tokens)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://jwt.io/introduction/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  eventDrivenArchitecture: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Event-Driven Architecture</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/event-driven-architecture/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  cqrs: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">CQRS (Command Query Responsibility Segregation)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://martinfowler.com/bliki/CQRS.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  devSecOps: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">DevSecOps</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.redhat.com/en/topics/devops/what-is-devsecops" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataLake: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Lake</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://aws.amazon.com/big-data/datalakes-and-analytics/what-is-a-data-lake/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  etl: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">ETL (Extract, Transform, Load)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.talend.com/resources/what-is-etl/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  monolith: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Monolith</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Monolithic_application" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataWarehouse: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Warehouse</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.oracle.com/data-warehouse/what-is-a-data-warehouse.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  graphDatabases: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Graph Databases (e.g., Neo4j)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://neo4j.com/what-is-a-graph-database/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  apm: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">APM (Application Performance Management)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.dynatrace.com/news/blog/what-is-apm/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  infrastructureAsCode: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Infrastructure as Code (IaC)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.redhat.com/en/topics/automation/what-is-infrastructure-as-code-iac" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  immutableInfrastructure: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Immutable Infrastructure</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.redhat.com/en/topics/automation/what-is-immutable-infrastructure" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  distributedLedgerTechnology: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Distributed Ledger Technology</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.ibm.com/blockchain/what-is-blockchain" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  chaosEngineering: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Chaos Engineering</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://principlesofchaos.org/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  reactiveProgramming: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Reactive Programming</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.reactivemanifesto.org/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataSharding: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Sharding</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.mongodb.com/basics/sharding" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  apiGateway: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">API Gateway</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://aws.amazon.com/api-gateway/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  webRTC: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">WebRTC (Web Real-Time Communication)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://webrtc.org/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataGovernance: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Governance</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://www.dataversity.net/what-is-data-governance/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataAnonymization: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Anonymization</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://en.wikipedia.org/wiki/Data_anonymization" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  federatedLearning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Federated Learning</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://ai.googleblog.com/2017/04/federated-learning-collaborative.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  explainableAI: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Explainable AI (XAI)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://en.wikipedia.org/wiki/Explainable_artificial_intelligence" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  syntheticData: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Synthetic Data</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Synthetic_data" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  quantumCryptography: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Quantum Cryptography</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Quantum_cryptography" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  digitalTwins: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Digital Twins</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Digital_twin" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  edgeAI: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Edge AI</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Edge_AI" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  homomorphicEncryption: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Homomorphic Encryption</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Homomorphic_encryption" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  fogComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Fog Computing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Fog_computing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  virtualPrivateCloud: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Virtual Private Cloud (VPC)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Virtual_private_cloud" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  hybridCloud: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Hybrid Cloud</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Hybrid_cloud" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  multiCloudStrategy: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Multi-Cloud Strategy</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Multicloud" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataOps: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">DataOps</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/DataOps" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  bioinformatics: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Bioinformatics</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <a href="https://en.wikipedia.org/wiki/Bioinformatics" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  gRPC: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">gRPC</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://grpc.io/docs/what-is-grpc/introduction/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dependencyGraph: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Dependency Graph</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.visual-paradigm.com/guide/software-development/what-is-dependency-graph/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  clusterComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cluster Computing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.techtarget.com/searchdatacenter/definition/cluster" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  messageQueues: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Message Queues</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.ibm.com/cloud/learn/message-queues" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  rateLimiting: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Rate Limiting</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.cloudflare.com/learning/ddos/ddos-rate-limiting/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  concurrency: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Concurrency</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.geeksforgeeks.org/concurrency-in-operating-system/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  verticalScaling: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Vertical Scaling</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.ibm.com/cloud/learn/scaling" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  horizontalScaling: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Horizontal Scaling</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.datadoghq.com/blog/horizontal-scaling/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  databaseIndexing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Database Indexing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.techopedia.com/definition/2788/indexing-database" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  dataReplication: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Replication</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.techtarget.com/searchdatamanagement/definition/data-replication" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  acidTransactions: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">ACID Transactions</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.ibm.com/cloud/learn/acid-properties" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  eventuallyConsistentSystems: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Eventually Consistent Systems</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.allthingsdistributed.com/2008/12/eventually_consistent.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  memoryLeaks: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Memory Leaks</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.pluralsight.com/blog/software-development/understanding-memory-leaks" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  namespace: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Namespace</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://docs.microsoft.com/en-us/cpp/cpp/namespaces-cpp" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  serviceDiscovery: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Service Discovery</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.consul.io/discovery.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  throttling: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Throttling</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.cloudflare.com/learning/bots/what-is-rate-limiting/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  functionAsAService: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Function as a Service (FaaS)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://aws.amazon.com/lambda/faas/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataLakehouse: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Lakehouse</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://databricks.com/glossary/data-lakehouse" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  eventLoop: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Event Loop</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  tokenization: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Tokenization</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.pcisecuritystandards.org/pdfs/pci_fs_data_tokenization.pdf" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  serverSentEvents: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Server Sent Events (SSE)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  messageBrokers: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Message Brokers</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.rabbitmq.com/tutorials/tutorial-one-python.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  cacheInvalidation: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cache Invalidation</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.cloudflare.com/learning/cdn/what-is-caching/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  immutableDataStructures: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Immutable Data Structures</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://immutable-js.github.io/immutable-js/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  
  dataDeduplication: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Deduplication</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://searchdatabackup.techtarget.com/definition/data-deduplication" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  statefulVsStatelessSystems: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Stateful vs Stateless Systems</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.cloudflare.com/learning/serverless/glossary/stateful-vs-stateless/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  zeroDowntimeDeployment: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Zero Downtime Deployment</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.digitalocean.com/community/tutorials/what-is-zero-downtime-deployment" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataPartitioning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Partitioning</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://docs.microsoft.com/en-us/sql/relational-databases/partitions/partitioned-tables-and-indexes?view=sql-server-ver15" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  featureBranching: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Feature Branching</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.atlassian.com/git/tutorials/comparing-workflows/feature-branch-workflow" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  deadlock: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Deadlock</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.geeksforgeeks.org/deadlock-in-operating-system/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  microBatching: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Micro-batching</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://spark.apache.org/docs/latest/streaming-programming-guide.html#window-operations" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  domainDrivenDesign: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Domain-Driven Design</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://martinfowler.com/bliki/DomainDrivenDesign.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  apiVersioning: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">API Versioning</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.mulesoft.com/resources/api/api-versioning-guide" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  distributedFileSystem: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Distributed File System (DFS)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.ibm.com/docs/en/zos/2.1.0?topic=concepts-distributed-file-system" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  statefulWidget: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Stateful Widget</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://flutter.dev/docs/development/ui/widgets-intro" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  serverlessFunctions: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Serverless Functions</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://aws.amazon.com/lambda/serverless-architectures-learn-more/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  edgeServices: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Edge Services</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.cloudflare.com/learning/edge/what-is-edge-computing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  darkLaunch: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Dark Launch</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://launchdarkly.com/blog/what-is-a-dark-launch/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  cloudSecurity: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cloud Security</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.cisco.com/c/en/us/solutions/enterprise-networks/cloud-security/index.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  scalability: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Scalability</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://azure.microsoft.com/en-us/overview/what-is-scalability/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
  eventStreamProcessing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Event Stream Processing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.confluent.io/event-stream-processing/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  multiTenancy: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Multi-Tenancy</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.redhat.com/en/topics/cloud-computing/what-is-multi-tenancy" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataLakesVsDataWarehouses: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Lakes vs Data Warehouses</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://aws.amazon.com/big-data/datalakes-and-analytics/data-lake-vs-data-warehouse/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  softwareContainers: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Software Containers</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.docker.com/resources/what-container/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  cloudOrchestration: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Cloud Orchestration</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.vmware.com/topics/glossary/content/cloud-orchestration" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  networkSlicing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Network Slicing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.ericsson.com/en/5g/numerology/network-slicing" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  IoTEdgeComputing: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">IoT Edge Computing</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.intel.com/content/www/us/en/internet-of-things/solutions/what-is-edge-computing.html" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  dataLakesAndWarehousesIntegration: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Data Lakes and Warehouses Integration</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://www.dataversity.net/integrating-data-lakes-data-warehouses/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,

  machineLearningOperations: `
    <h2 style="align-items: center;font-weight: bolder;font-size: 25px;">Machine Learning Operations (MLOps)</h2>
    <br>
    <p style="text-align: left; margin-bottom:30px; padding-bottom:30px; line-height:1.5;">
    ...
    <br>
    <a href="https://mlops.community/what-is-mlops/" class="modal-link" style="text-align: center;" target="_blank"> ⌁—— Read more about it ——⌁</a>
  `,
